...
### Create a farmer’s profile

Inside the “Farmers” page, click on “Add Farmer” button to create a new farmer profile. 

![producers55](/images/producers55.png)

Add Basic information and Address. Then you can add plots by clicking on “draw plot”. Alternatively, you can also add plots using the mobile app. 
...
After adding your plot, you will be directed back to the the farmer profile. You can add additional plots by drawing them or uploading geo-data. You can also export geo-data of the farmer’s plots.
...
![producers84](/images/producers84.png)
