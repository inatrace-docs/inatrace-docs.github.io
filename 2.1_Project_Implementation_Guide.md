...
<img src="/images/value_chain_analysis.png" alt="Value Chain Analysis" width="600">
...
<img src="/images/system_configurations.png" alt="System Configurations" width="600">

**System Configurations**

- _Modify data fields to match local requirements in system configurations (product types,facility types, processing action types, currencies, measuring units, etc.)_
- _Add company stakeholders to reflect local supply chain reality_

**Import of Basic Information**
- _Import farmers lists and other information that is available e.g. in form of excel sheets_

**Localization**

- _Translate interface into local language in case not available yet and add company-speficic translations where needed._
- _Adjust units of measurement, currency, and date formats._

**Create Accounts**
- _Create New Company Accounts and User Accounts_

**User Role & Permission Setup**
- _Define value chain roles for farmers, cooperatives, exporters etc._
- _Restrict access to sensitive business data._

**B2C Set-up**
- _Integrate text and media content for B2C websites_
